...
public class ArticleDO {
    ...
    private String firstPicture;  // 文章第一个图片

    private ArticleDO lastArticle;

    private ArticleDO nextArticle;
    ...
    public void setSeo(SeoDO seo) {
        this.seo = seo;
    }

    public TermDO getTerm() {
        return term;
    }

    public void setTerm(TermDO term) {
        this.term = term;
    }
    ...
    public ArticleDO getLastArticle() {
        return lastArticle;
    }

    public void setLastArticle(ArticleDO lastArticle) {
        this.lastArticle = lastArticle;
    }

    public ArticleDO getNextArticle() {
        return nextArticle;
    }

    public void setNextArticle(ArticleDO nextArticle) {
